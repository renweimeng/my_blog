  ...
  return (
    <button
      ...
      className={cn(
        ...
        compact ? "h-9 w-[104px] px-1 text-xs" : "h-10 w-[138px] px-2 text-sm",
    ...
    >
      ...
      />
      <span className={cn("relative z-10 flex w-full items-center justify-between font-medium", compact ? "px-1.5" : "px-2")}>
        <span
          className={cn(
